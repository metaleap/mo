...
bin/mo2d.exec: bin/mo2d_appviews_liveview_liveview.o bin/mo2d_appviews_shaderview_gui_cheatsheets.o bin/mo2d_appviews_shaderview_gui_shaders.o bin/mo2d_appviews_shaderview_shaderview.o bin/mo2d_gui_gui.o bin/mo2d_main.o
	$(CXX) $(CXXFLAGS) -Lbin -limgui -limgui-sfml -lsfml-graphics -lsfml-window -lsfml-system -lGL bin/mo2d_appviews_shaderview_gui_shaders.o bin/mo2d_appviews_shaderview_shaderview.o bin/mo2d_gui_gui.o bin/mo2d_main.o bin/mo2d_appviews_liveview_liveview.o bin/mo2d_appviews_shaderview_gui_cheatsheets.o -o bin/mo2d.exec
