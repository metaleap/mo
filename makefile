...
bin/mo2d.exec: bin/mo2d_appviews_shaderview_shaderview.o bin/mo2d_gui_gui.o bin/mo2d_main.o bin/mo2d_appviews_liveview_liveview.o bin/mo2d_appviews_shaderview_peek.o
	$(CXX) $(CXXFLAGS) -Lbin -limgui -limgui-sfml -lsfml-graphics -lsfml-window -lsfml-system -lGL bin/mo2d_main.o bin/mo2d_appviews_liveview_liveview.o bin/mo2d_appviews_shaderview_peek.o bin/mo2d_appviews_shaderview_shaderview.o bin/mo2d_gui_gui.o -o bin/mo2d.exec

bin/mo_noiselib_tuts.exec: bin/mo_noiselib_tuts_noiseutils.o bin/mo_noiselib_tuts_tuts.o bin/mo_noiselib_tuts_main.o
...
bin/mo2d_appviews_shaderview_peek.o: mo2d/appviews/shaderview/peek.cpp
	$(CXX) -c $(CXXFLAGS) -Ilibdeps/imgui -Ilibdeps/imgui/backends -Ilibdeps/imgui/misc -Ilibdeps/imgui/misc/cpp -Ilibdeps/imgui/misc/freetype -Ilibdeps/imgui/misc/single_file -Ilibdeps/imgui-sfml -Ilibdeps/libnoise -Ilibdeps/libnoise/include -Ilibdeps/libnoise/include/noise -Ilibdeps/libnoise/include/noise/model -Ilibdeps/libnoise/include/noise/module mo2d/appviews/shaderview/peek.cpp -o bin/mo2d_appviews_shaderview_peek.o
...
bin/mo2d_main.o: mo2d/main.cpp mo2d/appviews/shaderview/shaderview.h mo2d/appviews/shaderview/shaderview.cpp mo2d/appviews/liveview/liveview.h mo2d/appviews/liveview/liveview.cpp mo2d/gui/gui.h mo2d/gui/gui.cpp
