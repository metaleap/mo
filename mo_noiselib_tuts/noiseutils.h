...
class WriterBMP {
  ...
  public:
    /// Constructor.
    WriterBMP() : m_pSourceImage(nullptr) {
    }
  ...
  protected:
    ...
    ///
    /// Windows bitmap files require that the width of one hsorizontal line
...
class WriterTER {
  ...
  public:
    /// Constructor.
    WriterTER() : m_metersPerPoint(DEFAULT_METERS_PER_POINT), m_pSourceNoiseMap(nullptr) {
    }
